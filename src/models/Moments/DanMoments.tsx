...
//       new Episode("Misc", 24, "05/30/2014", "Catalyst Trailer", "https://youtu.be/sGhT2CcQF3k", []),
//       68,
//       [Tag.Lore],
//       [p.getPersonByName("Dan")],
...
//       DanImages.CPKDan
//     ),
//     new Moment("#6", e.GetH3TV(87), 228, [Tag.Lore], [p.getPersonByName("Dan")], DanImages.CPKDan),
//   ]),
//   new CrewPageSection("The Early Days", [
//     new Moment(
//       "How he got involved",
//       new Episode("Misc", 4567, "01/01/2015", "H3 Podcast - We Won The Lawsuit / Skippy and Ryan Jaunzemis", "https://www.twitch.tv/videos/169526220?collection=tCXPvh_s1RSQOA&t=02h47m05s",[]),
//       0,
//       [Tag.Lore],
//       [p.getPersonByName("Dan")],
...
//     new Moment(
//       "the fans demand DPI",
//       e.GetEpisodeByTitle("We Got Each Other The Worst Holiday Gifts (Live Audience!) - H3 Podcast #263"),
//       4119,
//       [Tag.Lore],
//       [p.getPersonByName("Dan")],
//       DanImages.DPIDan6
