...
export const AllFrenemies: Episode[] = new Array(
  ...
  new Episode(
    ...
    "https://www.youtube.com/watch?v=9xVGBL0_crc",
    "2020-10-13",
    [EpisodeType.Frenemies]
  ),
  new Episode(
    `Is Trisha Smarter Than A 5th Grader? - Frenemies #4`,
    "https://www.youtube.com/watch?v=B6hF6w_sMlw",
    "2020-10-06",
    [EpisodeType.Frenemies]
  ),
  new Episode(
    `Possibly Our Last Episode - Frenemies #3`,
    "https://www.youtube.com/watch?v=b35iUxkPazY",
    "2020-09-29",
    [EpisodeType.Frenemies]
  ),
  new Episode(
    `Trisha's Obsession With Jewish People - Frenemies #2`,
    "https://www.youtube.com/watch?v=FwLnl2T5z4A",
    "2020-09-22",
    [EpisodeType.Frenemies]
  ),
  new Episode(
    `Trisha's New Boyfriend Is Hila's Brother - Frenemies #1`,
    "https://www.youtube.com/watch?v=Mtblz3KPYT0",
    "2020-09-15",
    [EpisodeType.Frenemies]
  )
);
