...
export const JohnWilliamKirbyKelley = new IcebergItem(
  ...
  Moments.GetMomentsByTag(Tag["John William Kirbey Kelly"])
);

export const CodyPadrino = new IcebergItem(
  "The Cody Incident",
  ...
  Moments.GetMomentsByTag(Tag["Cody Padrino"])
);
export const VoiceFlamingoR = new IcebergItem(
  "VoiceFlamingo-R",
  "A bonkers user that posted about Ethan on /r/conspiracy stating that he thinks Ethan is using an FBI confirmed pedophile symbol on social media. ",
  Moments.GetMomentsByTag(Tag["VoiceFlamingo-R"])
);
