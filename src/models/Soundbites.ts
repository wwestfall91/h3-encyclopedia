...
// import * as 
// episodes from "./Episodes/AllEpisodes";
...
// export const Soundbites: Soundbite[] = new Array(
  ...
  //   [P.CarlosMatos], 
  //   episodes.GetEpisodeByTitle("How To Lose Your Life's Savings w Cryptocurrency")!,
  //   36
  // ),
  // new Soundbite(
  //   "Mmmm NO NO NO",
  ...
  //   [P.LoganPaul], 
  //   episodes.GetEpisodeByTitle("THESE GLASSES CURED OUR COLOR BLINDNESS! FT. iDubbbzTV"),
  //   684
  // ),
  // new Soundbite(
  ...
  //   [P.HowieMandel], 
  //   episodes.GetEpisodeByTitle("Ethan's Birthday Extravaganza LIVE From The Ace Theater!"),
  //   3910
  // ),
  // new Soundbite(
  ...
  //   new JeffEpisode(), 
  //   0, 
  //   "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcZ4Jcx5JW4LCjsdwMdSG0QVpubmrR-8l_h_BJBCYaoQ&s"
  // ),
  // new Soundbite(
  //   "Bruh.",
  //   SB.Misc_Bruh,
